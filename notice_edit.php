...
<body>
    ...
    ?>
    <div class="content">
        <form action="notice_edit_ok.php" name="frm1" method="post">
        <table class="table table-table bordered">
                    <tr>
                        <td>글제목</td>
                        <td>
                        <input type="hidden" name="no" value="<?=$no?>">
                        <input type="text" name="title" class="form-control" value="<?=$row["title"]?>"></td>
                    </tr>
                    <tr>
                        <td>글내용</td>
                        <td>
                    ...
                    <tr>
                        <td colspan='2' align='center'>
                            ...
                            <input type="button" class="btn btn-primary" value="취소" onclick="location.href='notice_content.php'">
                        </td>
                    </tr>
                </table>
        </form>
